...
public class AppInfo {
	...
	private List<String> screen;// 存放应用详情页的图片url
	private List<String> safeUrl;// 存放安全信息图片的URL
	private List<String> safeDesUrl;//
	private List<String> safeDes;// 存放安全信息描述的URL
	private List<Integer> safeDesColor;// 存放描述信息字体颜色的状态值
